...
from mmdet_mini.cv_core import (Config, load_checkpoint, FeatureMapVis, show_tensor, imdenormalize, show_img, imwrite,
                           traverse_file_paths)
...
def parse_args():
    ...
    parser.add_argument('--config',
                        # default='/home/tju531/hwr/mm-mini/configs/atss/atss_r50_fpn_1x_coco.py',
                        default='/home/tju531/hwr/mm-mini/configs/aa/atss.py',
    ...
    parser.add_argument(
        '--output_dir',
        # default='/home/tju531/hwr/mmdet_works/feature_show/atss/',
        default='/home/tju531/hwr/mmdet_works/feature_show/ours/',
