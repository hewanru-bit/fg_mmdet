...
from cv_core import (Config, load_checkpoint, FeatureMapVis, show_tensor, imdenormalize, show_img, imwrite,
                           traverse_file_paths)
...
def create_featuremap_vis(cfg, use_gpu=True, init_shape=(320, 320, 3)):
    ...
    model.forward = partial(forward, model) # 提供一种对于函数固定属性的函数
