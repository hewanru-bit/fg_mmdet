...
from tools.mm_vis.cv_core.utils import _BatchNorm, _InstanceNorm, build_from_cfg, is_list_of
from tools.mm_vis.cv_core.utils.ext_loader import check_ops_exist
...
class DefaultOptimizerConstructor:
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        if check_ops_exist():
            from mmdet.cv_core.ops import DeformConv2d, ModulatedDeformConv2d
