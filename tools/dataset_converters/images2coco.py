...
def parse_args():
    ...
    parser.add_argument('--img_path', default='/home/tju531/hwr/Datasets/RESIDE/RTTS/0_raw/',help=' root path of images')
    parser.add_argument(
        '--classes', type=str, default=['aeroplane','bicycle','bird','boat ','bottle',],help='The text file name of storage class list')
    parser.add_argument(
        '--out',
        default='rtts.json',
        type=str,
