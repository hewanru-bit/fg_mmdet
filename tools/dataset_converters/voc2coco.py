'''数据集RTTS数据类型voc为了使用tide进行分析，转成coco类型,  源文件pascal_voc.py'''
...
def parse_args():
    ...
    parser.add_argument('--devkit_path',default='/home/tju531/hwr/Datasets/RESIDE/RTTS/', help='pascal voc devkit path')
    parser.add_argument('-o', '--out-dir',default='/home/tju531/hwr/Datasets/RESIDE/RTTS/rtts_coco/', help='output path')
    parser.add_argument(
        '--out-format',
        default='coco',
        choices=('pkl', 'coco'),
